    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('admin') }}">Sistem Informasi Klinik</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link" href="{{ url('admin/obat') }}">Obat</a>
                        <a class="nav-link" href="{{ url('admin/pegawai') }}">Pegawai</a>
                        <a class="nav-link" href="{{ url('admin/tindakan') }}">Tindakan</a>
                        <a class="nav-link" href="{{ url('admin/transaksi') }}">Transaksi</a>
                        <a class="nav-link" href="{{ url('admin/pasien') }}">Pasien</a>
                    </div>
